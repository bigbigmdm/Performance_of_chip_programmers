...
| CH341A     | IMSProg v1.8.2          | Linux/GUI  |  33.2s  |  12.3s  | 216.4s   |   33.2s   |
| CH341A     | IMSProg v1.8.3          | Linux/GUI  |  33.2s  |  12.2s  |  97.5s   |   33.2s   |
...
| CH347T     | IMSProg v1.8.2          | Linux/GUI  |   1.7s  |  11.4s  |  43.4s   |    1.7s   |
| CH347T     | IMSProg v1.8.3          | Linux/GUI  |   1.6s  |  11.4s  |  38.8s   |    1.6s   |
...
| :---       |       :---              |     :---   |:---:|:---:|:---:|:---:| :---:  |   :---:   |   :---:   |:---:|:---:|:---:|
| CH341A  / CH347T | [IMSProg v1.8.1](https://github.com/bigbigmdm/IMSProg)         | Linux/GUI  | ✔   | ✔  | ✔   | ✔   |  ✔     |     ✔    |  ✔  | ✔ | ✔ | ✔ |
